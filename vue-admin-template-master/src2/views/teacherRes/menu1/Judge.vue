<template>
  <div class="app-container">
    ...
    <!-- 答题窗口 -->
    <el-dialog title="判断题" :visible.sync="QuestionVisible">
      <div
        :rules="rules"
        :model="temp"
        label-position="left"
      ...
      >{{ temp.tigan }}</div>
      <el-form :model="temp">
        <el-form-item label="" prop="usrAns">
          <el-radio-group v-model="temp.usrAns" size="medium">
            <el-radio
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 650px; margin-left:0px;">
        ...
        <el-form-item label="答案" prop="rightAns">
          <el-radio-group v-model="temp.rightAns" size="medium">
            <el-radio
              v-for="(item, index) in ansOptions"
              :key="index"
              :label="item.value"
