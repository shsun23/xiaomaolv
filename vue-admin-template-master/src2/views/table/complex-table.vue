    ...
    >
      ...
      <el-table-column label="标题" min-width="150px">
        <template slot-scope="{row}">
          ...
          <span class="link-type" @click="videoOn(row)">{{ row.title }}</span>
      ...
      <el-table-column label="操作" align="center" width="230" class-name="small-padding fixed-width">
        <template slot-scope="{row,$index}">
          ...
          <!-- <el-button type="primary" size="mini" @click="btnClick()">
            Edit
          </el-button> -->
...
export default {
  ...
  methods: {
    ...
    btnClick() {
      const vm = this
      vm.$router.push({ path: '/teacherManage/create' })
    },
    videoOn(row) {
      const vm = this
      vm.$router.push({ path: '/table/test' })
    },
    submitForm() {
      this.$refs['elForm'].validate(valid => {
        ...
        // var options = {
        //   url: 'api/video/upVideo',服务器地址
        //   url: 'http://httpbin.org/#/Anything/post_anything',
        //   data: formData1,
        //   method: 'post',
        //   headers: {
